    ...
    return (
      <nav class="navbarStyle">
        ...
        <div className='section2'>
          ...
          <Link to='/createuser'><button class="btn btn-outline-success my-2 my-sm-0" type="submit">Create User</button> </Link>
          <Link to='/addtoken'><button class="btn btn-outline-warning my-2 my-sm-0" type="submit">Add NewToken</button> </Link>
        </div>
      </nav>
    );
